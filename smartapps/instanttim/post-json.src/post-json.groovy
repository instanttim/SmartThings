 ...
 * 
 *  Originally "smartapp.log-to-graphite"
...
definition(
	name: "Post JSON",
	namespace: "instanttim",
	author: "Timothy Martin",
	description: "Log sensor data to your own PHP/MySQL server.",
...
preferences {
    ...
    section ("Server") {
		input "json_host", "text", title: "Hostname/IP"
        input "json_port", "number", title: "Port"
    }
}
