 ...
 */
metadata {
	definition (name: "Fibaro Motion Sensor (instanttim)", namespace: "instanttim", author: "Timothy Martin") {
		capability "Battery"
    ...
    tiles(scale: 2) {
		...
		standardTile("tamper", "device.tamper", width: 2, height: 2) {
			state("active", label:'Tamper!', icon:"st.security.alarm.alarm", backgroundColor:"#53a7c0")
			state("inactive", label:'Inactive', icon:"st.security.alarm.clear", backgroundColor:"#ffffff")
		}
        ...
        main "motion"
        details(["motion","temperature","tamper","illuminance","battery"])
    }
}
